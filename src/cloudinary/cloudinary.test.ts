...
describe("cloudinary", () => {
  ...
  test.skip("uploadOne", async () => {
    ...
    expect(res).toEqual({
      id: "zwusu8zatxweth8jdcyn",
      url: "https://res.cloudinary.com/dojbazopp/image/upload/v1640189013/zwusu8zatxweth8jdcyn.jpg",
    });
  });

  test.skip("getOneByPublicId", async () => {
    const public_id = "asjzbkgcxokueq9ylgyh";
